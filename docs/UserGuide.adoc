...
=== Checking overall balance: `balance` or `b`

Calculates your total balance. +
Format: `balance` or `b`

=== Seeing which contact owes you the most: `max` or `m`

Lists the contact which owes you the most money. +
Format: `max`

=== Seeing which contact owes you the least: `min` or `mi`

Lists the contact to which you owe the most money. +
Format: `min`

=== Seeing all the contacts that owe you money: `lent` or `le`

Lists all the contacts that owe you an amount.
Format: `lent` or `le`

=== Seeing all the contacts that owe you money: `debt` or `de`

Lists all the contacts that owe you an amount.
Format: `debt` or `de`

=== Applies an interest rate to your balance: `interest FACTOR` or `i FACTOR`

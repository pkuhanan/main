...
* *Minor Enhancement*: Allow users to wipe all balances in their addressbook
* *Minor Enhancement*: Show the all the people who owe the user money
* *Minor Enhancement*: Show the all the people who the user owes money to

...
In terms of the Model component, a new Money model was created and the Person and Addressbook models required modifications to integrate the new Money model.

The Money model was written to be consistent with the existing Person attribute models like "Email" and "Phone". 

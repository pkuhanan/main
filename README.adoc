...
https://ci.appveyor.com/project/chenchongsong/travelbanker[image:https://ci.appveyor.com/api/projects/status/rw1wk4lgreqrtf0y/branch/master?svg=true[Build status]]
